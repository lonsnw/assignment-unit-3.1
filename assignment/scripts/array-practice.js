...
let favoriteFoods = [`asparagus`, `oranges`, `snap peas`, `broccoli`, `mushrooms`];
console.log(`here's some of my favorite produce:`, favoriteFoods);
...
console.log(`the last animal is`, lastLastAnimal);
...
console.log(`added a dessert to my list:`, favoriteFoods);
...
console.log(`added an entree to my list:`, favoriteFoods);
...
console.log(`here's the original list of colors:`, colors);
let lastColor = colors.pop()
console.log(`i've now removed the last color,`, lastColor);
console.log(`now the list is:`, colors);
...
console.log(`here's the post-pop list of colors:`, colors);
let firstColor = colors.shift()
console.log(`i've now removed the first color,`, firstColor);
console.log(`now the list is:`, colors);
...
gems.sort();
console.log(`i'm trying to sort the array:`, gems);
gems.reverse();
console.log(`now i've reversed the sorting`, gems);
